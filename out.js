...
(function dartProgram() {
  ...
  A = {
    main: function($arguments) {
      var t1;
      P.print("Hello world!");
      t1 = P._Platform_environment()._map;
      P.print("ENV PWD=" + H.S(t1.$index(0, "PWD")));
      P.print("ENV LOGNAME=" + H.S(t1.$index(0, "LOGNAME")));
      P.print("ENV PATH=" + H.S(t1.$index(0, "PATH")));
      P.print(C.JSString_methods.$add("Platform.executableArguments=", P.Platform_executableArguments().toString$0(0)));
    }
  };
